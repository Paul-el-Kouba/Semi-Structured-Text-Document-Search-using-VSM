...
what I need to add to index:
    ...
    N: nb of documents
    TF: number of occurences in the doc
...
temp_index = add_to_index("D03", {'apple': 1, 'john': 1, 'samsung': 2, 'paul': 1, 'mark': 3, 'aub': 1}, {'D01': {'ece': 1, 'john': 2, 'cramer': 2, 'takagi': 1, 'mark': 1, 'lau': 1}, 'D02': {'coe': 1, 'paul': 2, 'cramer': 2, 'joe': 1, 'mark': 1, 'aub': 1}}, {'ece': 1, 'john': 1, 'cramer': 2, 'takagi': 1, 'mark': 2, 'lau': 1, 'coe': 1, 'paul': 1, 'joe': 1, 'aub': 1})
